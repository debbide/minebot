...
```json
{
  ...
  "id": "uuid",
  "action": "START|STOP|RESTART|KILL|COMMAND|STATS|LOGS|LIST|READ|WRITE|MKDIR|DELETE|RENAME|COPY|COMPRESS|DECOMPRESS|UPLOAD_INIT|UPLOAD_CHUNK|UPLOAD_FINISH|DOWNLOAD_INIT|DOWNLOAD_CHUNK",
  "payload": {},
  "ts": 1730000000
}
```
